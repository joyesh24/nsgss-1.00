...
const notices = [
  {
    id: 1,
    title: "বার্ষিক পরিক্ষার ফলাফল    date: "২৬ ডিসেম্বর, ২০২৩",
    author: "প্রধান শিক্ষক",
    content: "আগামী ২৬ ডিসেম্বর, ২০২৪ তারিখে বিদ্যালয়ের বার্ষিক পরিক্ষার ফলাফল দেওয়া হবে। সকল শিক্ষার্থীদের আসার করার জন্য অনুরোধ করা হচ্ছে।"
  },
